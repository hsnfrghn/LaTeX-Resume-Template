...
\vspace{0.1em}
Node.js, Laravel, Express.js, Composer, MySQL, Redis \\
\dotline

\textbf{Frontend Development:} \\
\vspace{0.1em}
React, Vue.js, jQuery, Elementor, Alpine.js, Tailwind, Bootstrap, Blade templating engine, Livewire, Inertia.js, Webpack \\
\dotline

\textbf{Architecture \& APIs:} \\
\vspace{0.1em}
REST API / GraphQL, Microservices, Domain-Driven Design (DDD), SOLID, JWT / OAuth2\\
