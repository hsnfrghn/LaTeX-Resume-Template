...
\vspace{0.1em}
{\small Laravel, WordPress, Composer, WooCommerce, MySQL, Redis, Blade, SOLID, REST API/GraphQL, JWT/OAuth2, Microservices architecture, Domain-Driven Design (DDD), CSRF, XSS} \\
\dotline

\textbf{Frontend Development:} \\
\vspace{0.1em}
{\small React, Vue.js, jQuery, Elementor, Alpine.js, Tailwind, Bootstrap, Livewire, Inertia.js, Webpack, Vite, Sass, PostCSS, Accessibility (a11y)} \\
\dotline

\textbf{Systems \& Workflow:} \\
\vspace{0.1em}
{\small Git, Docker, Linux, MS Windows, CI/CD, Caching strategies, Role-Based Access Control (RBAC), Role-Based Access Control (RBAC), Role-Based Access Control (RBAC)}
