...
\vspace{0.1em}
{\small Git, Docker, Linux, Apache, CI/CD, Caching strategies, SOLID, Domain-Driven Design (DDD), Microservices, JWT/OAuth2, Role-Based Access Control (RBAC)} \\
\dotline
...
\vspace{0.1em}
{\small Technical scoping \& estimation, system design, code review, mentoring, stakeholder communication} \\
\dotline
