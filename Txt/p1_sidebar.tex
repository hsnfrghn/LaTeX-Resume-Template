...
\vspace{0.1em}
Laravel, WordPress, WooCommerce, Composer, MySQL, Redis, Blade, REST API / GraphQL, JWT / OAuth2, Microservices architecture, Domain-Driven Design (DDD), SOLID, Docker, Linux \\
\dotline
...
\vspace{0.1em}
% Git, Docker, Linux, MS Windows, CI/CD, Kubernetes, Nginx, Apache, AWS, DigitalOcean, Azure, Database indexing and optimization,
